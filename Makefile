...
EFI_TOOLCHAIN	:= GCC5
EFI_TIMEOUT	:= 3
EFI_FLAGS	:= --pcd=PcdPlatformBootTimeOut=$(EFI_TIMEOUT) --pcd=gRaspberryPiTokenSpaceGuid.PcdRamMoreThan3GB=1 --pcd=gRaspberryPiTokenSpaceGuid.PcdRamLimitTo3GB=0 --pcd=gRaspberryPiTokenSpaceGuid.PcdSystemTableMode=1
